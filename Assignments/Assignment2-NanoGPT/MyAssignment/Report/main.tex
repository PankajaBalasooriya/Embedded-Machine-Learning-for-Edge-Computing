...
using the character-level tokenization and ReLU activation, and the word-level tokenization model 
...
and generated text}.Both models were trained for 15000 iterations on the same Tiny Shakespeare dataset, using identical
hyperparameters except for the mentioned changes. 
Training of both models were performed on a Intel Core i7-13650HX, NVIDIA RTX 4060 6GB with 16GB of RAM and pytorch v2.3.1, Cuda v12.1. 
\vspace{-10pt}
\section{Results}
\vspace{-10pt}
